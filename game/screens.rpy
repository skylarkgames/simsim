...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Скип") action Skip() alternate Skip(fast=True, confirm=True)
...
screen main_menu_1():
    ...
    imagebutton:
        idle "gui/menugui/name.png"
        xalign 0.5 yalign 0
        action OpenURL("tg://resolve?domain=mrrva_dev")

    imagebutton:
        idle "gui/menugui/start.png"
        xalign 0.5 yalign 0.55
        action Start()

    imagebutton:
        idle "gui/menugui/load.png"
        xalign 0.5 yalign 0.65
        action ShowMenu("load")

    imagebutton:
        idle "gui/menugui/settings.png"
        xalign 0.5 yalign 0.75
        action ShowMenu('preferences')

    imagebutton:
        idle "gui/menugui/exit.png"
        xalign 0.5 yalign 0.85
        action Quit(confirm=False)

    imagebutton:
        idle "gui/menugui/git.png"
        xalign 0.95 yalign 0.97
        action OpenURL("https://github.com/skylarkgames/simsim")

    imagebutton:
        idle "gui/menugui/logo.png"
        xalign 0.90 yalign 0.97
        action OpenURL("https://skylarkgames.github.io/")
...
screen main_menu_2():
    ...
    imagebutton:
        idle "gui/menugui/cc.png"
        xalign 0.001 yalign 0.999
        action Start()

    imagebutton:
        idle "gui/menugui/nostart.png"
        xalign 0.5 yalign 0.55
        #action Start()

    imagebutton:
        idle "gui/menugui/noload.png"
        xalign 0.5 yalign 0.65
        #action ShowMenu("load")
...
screen main_menu():
    ...
    if persistent.ending == False:
        use main_menu_1
    elif persistent.ending == True:
        use main_menu_2
    else:
